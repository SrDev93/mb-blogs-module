            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered text-nowrap border-bottom w-100" id="responsive-datatable">
                                <thead>
                                <tr>
                                    <th class="wd-15p border-bottom-0">نام تگ</th>
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form id="form-{{ $item->id }}" action="{{ route('tags.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                        </td>
                    ...
                    <div class="card-footer">
                        <a href="{{ route('tags.create') }}" class="btn btn-primary">افزودن تگ</a>
                    </div>
                </div>
            </div>
        </div>
